...
export default function Register({handleClose, handleSignIn}:{handleClose: () => void, handleSignIn:() => void}) {
  const {
    register,
    handleSubmit,
    formState: { errors },
      ...
      <div className="relative flex w-full max-w-4xl  rounded-lg shadow-xl">
        ...
        <div className="flex w-full flex-col items-center justify-center bg-[#39c4d8] p-8 text-center text-white md:w-2/5">
          <div className="max-w-xs">
            ...
            <p className="mb-8">If you have a personal account, please sign in</p>
            <Button
        ...
        <div className="w-full bg-white p-8 md:w-3/5">
          <div className="mx-auto max-w-md">
            <h1 className="mb-2 text-center text-2xl font-bold text-[#0f3c69] md:text-3xl">Create Account</h1>
            <p className="mb-8 text-center text-gray-500">Use your email for registration</p>
